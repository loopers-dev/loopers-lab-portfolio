        ...
        visual: (
            <div className="space-y-3">
                <div className="flex gap-2">
                    ...
                    <motion.div initial={{ scale: 0 }} whileInView={{ scale: 1 }} viewport={{ once: true }} transition={{ delay: 0.3 }} className="h-10 px-4 rounded-lg border border-zinc-800 flex items-center justify-center text-xs">Outline</motion.div>
                </div>
                <div className="flex gap-2">
        ...
        <Layout>
            <main className="pt-32 pb-24 relative">
                ...
                <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                                ...
                                <motion.div key={cylinder.id} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: index * 0.1 }}>
                                    <Card className="h-full border-zinc-800 hover:border-primary/30">
                                        <CardContent className="p-8">
                                            ...
                                            <div className="p-4 rounded-xl bg-zinc-800/30 border border-zinc-800">{cylinder.visual}</div>
                                        </CardContent>
                                    </Card>
                                </motion.div>
                            ))}
                    ...
                    <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center p-16 rounded-2xl border border-zinc-800 bg-zinc-900 relative overflow-hidden">
                        ...
                        <div className="relative">
                            ...
                            <p className="text-gray-400 mb-8 max-w-xl mx-auto">Ready to work with a team that cares as much about your product as you do?</p>
                            <Link href="/contact">
