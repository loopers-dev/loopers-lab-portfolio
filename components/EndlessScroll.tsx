...
// ============================================================
// === LOCAL IMAGE LOADING (commented out for git push) ========
// === Uncomment below and comment out CLOUDINARY section to revert
// ============================================================
// const TOTAL_FRAMES = 240;
// const FRAME_PATH = '/4k-earth/';

// ============================================================
// === CLOUDINARY IMAGE LOADING (active) =======================
// === Generated by: node --env-file=.env scripts/fetch-cloudinary-urls.js
// === Comment this import and uncomment LOCAL section to revert
// ============================================================
import { EARTH_FRAME_URLS, TOTAL_FRAMES } from '@/config/cloudinaryUrls';
...
export default function EndlessScroll() {
    ...
    return (
        <div id="home-hero" ref={containerRef} className="relative" style={{ height: '400vh' }}>
