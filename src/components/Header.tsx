...
export default function Header() {
    ...
    useEffect(() => {
        const activeIndex = navLinks.findIndex(link => link.href === location.pathname);
                ...
                <nav className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        <div className="flex items-center justify-between">
                            {/* Logo */}
                            <Link to="/" className="flex items-center gap-3 group" onClick={(e) => { e.preventDefault(); cycleColorTheme(); navigate('/'); }}>
                                <motion.div
