                        ...
                        <ScrollReveal animation="fadeRight" delay={0.2}>
                            <div className="mb-12">
                                ...
                                <a
                                    ...
                                    className="text-2xl gradient-text hover:opacity-80 transition-opacity"
                                >
                                    hello@studio.com
                                </a>
                            </div>
                            ...
                            <Card className="p-8" hoverable glow>
                                <CardContent className="p-0">
                                    <h3 className="text-lg font-bold text-white/90 mb-6">
                                        What to Expect
                                    </h3>
                                    <StaggerList className="space-y-4" staggerDelay={0.1}>
                                        <div className="flex items-start gap-3 text-white/50">
                                            <PulsingDot className="mt-1.5" size="sm" />
                                            We respond within 2 business days.
                                        </div>
                                        <div className="flex items-start gap-3 text-white/50">
                                            <PulsingDot className="mt-1.5" size="sm" />
                                            If there's a fit, we'll schedule a short discovery call.
                                        </div>
                                        <div className="flex items-start gap-3 text-white/50">
                                            <PulsingDot className="mt-1.5" size="sm" />
                                            From there, we'll determine next steps together.
                                        </div>
                                    </StaggerList>
                                </CardContent>
                            </Card>
